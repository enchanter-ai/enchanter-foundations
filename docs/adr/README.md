...
| 0002 | [Taxonomy expansion to F15–F21 and deferred 5-axis migration decision](./0002-taxonomy-expansion.md) | Accepted; structural question resolved via hybrid in `packages/core/taxonomy/axes.md` (added 2026-05-05) |
