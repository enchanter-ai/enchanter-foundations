...
- **Evidence-collection mechanism:** Daily hash of every file in `vis/compliance/` (soc2.md, nist-ai-rmf.md, iso-42001.md, fedramp-boundary.md, this folder) — the customer-facing control documentation.
- **Producer (today):** `vis/compliance/*.md`, per-repo `README.md`.
