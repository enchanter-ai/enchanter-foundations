...
- **Evidence-collection mechanism:** Daily `log-tail` event referencing F-code triage entries per `shared/conduct/failure-modes.md` and the F01-F21 runbooks under `vis/runbooks/`.
